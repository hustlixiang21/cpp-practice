...
int main()
{
    ...
    pair<vector<int>::iterator, vector<int>::iterator> res = mismatch(ivector.begin(), ivector.end(), ivector3.begin());
    cout << res.first - ivector.begin() << "\t" << res.second - ivector3.begin() << endl;
